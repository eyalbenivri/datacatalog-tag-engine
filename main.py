...
def set_default():
    ...
    group = get_group_from_group_key(request.form['group_key'].rstrip(), session['groups'])
...
def ondemand_updates():
    ...
    if 'included_uris' in json:
        ...
        success, config = teu.lookup_config_by_included_uris(group['group_key'], template_uuid, None,
                                                             included_uris_hash)
