...
class TaskManager:
    ...
    def create_config_uuid_tasks(self, job_uuid, config_uuid, config_type, uris):
        ...
        for shard_index in range(0, shards):
            ...
            for uri_index, uri_val in enumerate(uris[task_running_total:], task_running_total):
                ...
                task_uuid = self._record_config_uuid_task(job_uuid, shard_uuid, task_id, config_uuid, config_type,
                                                          uri_val)
                self._create_config_uuid_task(job_uuid, shard_uuid, task_uuid, task_id, config_uuid, config_type,
                                              uri_val)
    ...
    def create_tag_extract_tasks(self, job_uuid, config_uuid, config_type, tag_extract_list):
        ...
        for shard_index in range(0, shards):
            ...
            for extract_index, extract_val in enumerate(tag_extract_list[task_running_total:], task_running_total):
                ...
                task_uuid = self._record_tag_extract_task(job_uuid, shard_uuid, task_id, config_uuid, config_type,
                                                          extract_val)
                self._create_tag_extract_task(job_uuid, shard_uuid, task_uuid, task_id, config_uuid, config_type,
                                              extract_val)
    ...
    def _create_config_uuid_task(self, job_uuid, shard_uuid, task_uuid, task_id, config_uuid, config_type, uri):
        ...
        payload = {
            'job_uuid':    job_uuid, 'shard_uuid': shard_uuid, 'task_uuid': task_uuid,
            'config_uuid': config_uuid, 'config_type': config_type, 'uri': uri
        }
    ...
    def _create_tag_extract_task(self, job_uuid, shard_uuid, task_uuid, task_id, config_uuid, config_type, extract):
        ...
        payload = {
            'job_uuid':    job_uuid, 'shard_uuid': shard_uuid, 'task_uuid': task_uuid, 'config_uuid': config_uuid, \
